const translation = {
  ...
  welcome: 'Bienvenue sur AiNguyenPhamHung, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer AiNguyenPhamHung Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur AiNguyenPhamHung',
  invalid: 'Le lien a expiré',
  explore: 'Explorez AiNguyenPhamHung',
  ...
  resetPasswordDesc: 'Tapez l’adresse e-mail que vous avez utilisée pour vous inscrire sur AiNguyenPhamHung et nous vous enverrons un e-mail de réinitialisation de mot de passe.',
  usePassword: 'Utiliser le mot de passe',
  licenseInactiveTip: 'La licence AiNguyenPhamHung Enterprise de votre espace de travail est inactive. Veuillez contacter votre administrateur pour continuer à utiliser AiNguyenPhamHung.',
  licenseLostTip: 'Échec de la connexion au serveur de licences AiNguyenPhamHung. Veuillez contacter votre administrateur pour continuer à utiliser AiNguyenPhamHung.',
  licenseExpired: 'Licence expirée',
  licenseLost: 'Licence perdue',
  licenseExpiredTip: 'La licence AiNguyenPhamHung Enterprise de votre espace de travail a expiré. Veuillez contacter votre administrateur pour continuer à utiliser AiNguyenPhamHung.',
