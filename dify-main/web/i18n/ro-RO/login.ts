const translation = {
  ...
  welcome: 'Bine ai venit la AiNguyenPhamHung, te rugăm să te autentifici pentru a continua.',
  ...
  license: {
    tip: 'Înainte de a începe AiNguyenPhamHung Community Edition, citește',
    link: 'Licența open-source de pe GitHub',
  },
  join: 'Alătură-te',
  joinTipStart: 'Te invităm să te alături echipei',
  joinTipEnd: 'pe AiNguyenPhamHung',
  invalid: 'Link-ul a expirat',
  explore: 'Explorează AiNguyenPhamHung',
  ...
  or: 'SAU',
  resetPasswordDesc: 'Tastați e-mailul pe care l-ați folosit pentru a vă înscrie pe AiNguyenPhamHung și vă vom trimite un e-mail de resetare a parolei.',
  changePasswordBtn: 'Setați o parolă',
  licenseLostTip: 'Nu s-a reușit conectarea serverului de licențe AiNguyenPhamHung. Contactați administratorul pentru a continua să utilizați AiNguyenPhamHung.',
  licenseInactive: 'Licență inactivă',
  licenseInactiveTip: 'Licența AiNguyenPhamHung Enterprise pentru spațiul de lucru este inactivă. Contactați administratorul pentru a continua să utilizați AiNguyenPhamHung.',
  licenseExpired: 'Licență expirată',
  licenseLost: 'Licență pierdută',
  licenseExpiredTip: 'Licența AiNguyenPhamHung Enterprise pentru spațiul de lucru a expirat. Contactați administratorul pentru a continua să utilizați AiNguyenPhamHung.',
  webapp: {
