const translation = {
  ...
  otherDataSource: {
    ...
    description: 'Derzeit verfügt die Wissensdatenbank von AiNguyenPhamHung nur über begrenzte Datenquellen. Das Beitragen einer Datenquelle zur AiNguyenPhamHung-Wissensdatenbank ist eine fantastische Möglichkeit, die Flexibilität und Leistungsfähigkeit der Plattform für alle Benutzer zu verbessern. Unser Beitragsleitfaden erleichtert Ihnen den Einstieg. Bitte klicken Sie auf den untenstehenden Link, um mehr zu erfahren.',
  },
  watercrawl: {
