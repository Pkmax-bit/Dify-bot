const translation = {
  ...
  welcome: 'Willkommen bei AiNguyenPhamHung, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit AiNguyenPhamHung Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf AiNguyenPhamHung beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'AiNguyenPhamHung erkunden',
  ...
  resetPasswordDesc: 'Geben Sie die E-Mail-Adresse ein, mit der Sie sich bei AiNguyenPhamHung angemeldet haben, und wir senden Ihnen eine E-Mail zum Zurücksetzen des Passworts.',
  ...
  licenseLostTip: 'Fehler beim Verbinden des AiNguyenPhamHung-Lizenzservers. Wenden Sie sich an Ihren Administrator, um AiNguyenPhamHung weiterhin zu verwenden.',
  licenseInactive: 'Lizenz inaktiv',
  licenseInactiveTip: 'Die AiNguyenPhamHung Enterprise-Lizenz für Ihren Arbeitsbereich ist inaktiv. Wenden Sie sich an Ihren Administrator, um AiNguyenPhamHung weiterhin zu verwenden.',
  licenseExpiredTip: 'Die AiNguyenPhamHung Enterprise-Lizenz für Ihren Arbeitsbereich ist abgelaufen. Wenden Sie sich an Ihren Administrator, um AiNguyenPhamHung weiterhin zu verwenden.',
