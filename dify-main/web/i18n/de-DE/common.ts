const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'AiNguyenPhamHung-Konto',
    langGeniusAccountTip: 'Ihr AiNguyenPhamHung-Konto und zugehörige Benutzerdaten.',
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet, und sie können sich bei AiNguyenPhamHung anmelden, um auf Ihre Teamdaten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der OpenAI-Hostingdienst von AiNguyenPhamHung ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  apiBasedExtension: {
    title: 'API-Erweiterungen bieten zentralisiertes API-Management und vereinfachen die Konfiguration für eine einfache Verwendung in AiNguyenPhamHungs Anwendungen.',
  ...
  about: {
    ...
    nowAvailable: 'AiNguyenPhamHung {{version}} ist jetzt verfügbar.',
    latestAvailable: 'AiNguyenPhamHung {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',
