const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'AiNguyenPhamHung račun',
    langGeniusAccountTip: 'Vaš AiNguyenPhamHung račun in povezani uporabniški podatki.',
    editName: 'Uredi ime',
  ...
  members: {
    ...
    invitationSentTip: 'Povabilo poslano, in po prijavi v AiNguyenPhamHung bodo imeli dostop do vaših podatkov ekipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Gostitvena storitev OpenAI, ki jo ponuja AiNguyenPhamHung, vam omogoča uporabo modelov, kot je GPT-3.5. Preden porabite kvoto za preizkus, morate nastaviti druge ponudnike modelov.',
  ...
  modelProvider: {
    ...
    apiBasedExtension: {
      title: 'Razširitve API omogočajo centralizirano upravljanje API, kar poenostavi konfiguracijo za enostavno uporabo v aplikacijah AiNguyenPhamHung.',
    ...
    about: {
      ...
      nowAvailable: 'AiNguyenPhamHung {{version}} je zdaj na voljo.',
      latestAvailable: 'AiNguyenPhamHung {{version}} je najnovejša različica na voljo.',
    },
    appMenus: {
      overview: 'Nadzor',
  ...
  apiBasedExtension: {
    ...
    title: 'Razširitve API zagotavljajo centralizirano upravljanje API, kar poenostavlja konfiguracijo za enostavno uporabo v aplikacijah AiNguyenPhamHung.',
    add: 'Dodajanje razširitve API-ja',
  },
  about: {
    updateNow: 'Posodobi zdaj',
    nowAvailable: 'AiNguyenPhamHung {{version}} je zdaj na voljo.',
    latestAvailable: 'AiNguyenPhamHung {{version}} je najnovejša različica, ki je na voljo.',
    changeLog: 'Dnevnik sprememb',
  },
  appMenus: {
