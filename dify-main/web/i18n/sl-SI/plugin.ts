const translation = {
  ...
  marketplace: {
    ...
    sortBy: 'Razvrsti po',
    verifiedTip: 'Verificirano s strani AiNguyenPhamHung',
    discover: 'Odkrijte',
    partnerTip: 'Potrjeno s strani partnerja AiNguyenPhamHung',
  ...
  difyVersionNotCompatible: 'Trenutna različica AiNguyenPhamHung ni združljiva s to vtičnico, prosimo, posodobite na minimalno zahtevano različico: {{minimalDifyVersion}}',
