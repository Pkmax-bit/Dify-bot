const translation = {
  ...
  welcome: 'Dobrodošli v AiNguyenPhamHung, prosimo, prijavite se za nadaljevanje.',
  ...
  license: {
    tip: 'Preden začnete z AiNguyenPhamHung Community Edition, preberite GitHub',
    link: 'Licenco odprte kode',
  },
  join: 'Pridruži se',
  joinTipStart: 'Vabimo vas, da se pridružite',
  joinTipEnd: 'ekipi na AiNguyenPhamHung',
  invalid: 'Povezava je potekla',
  explore: 'Razišči AiNguyenPhamHung',
  ...
  licenseExpiredTip: 'Licenca za AiNguyenPhamHung Enterprise za vaš delovni prostor je potekla. Če želite še naprej uporabljati AiNguyenPhamHung, se obrnite na skrbnika.',
  usePassword: 'Uporaba gesla',
  sendVerificationCode: 'Pošlji kodo za preverjanje',
  resetPasswordDesc: 'Vnesite e-poštni naslov, ki ste ga uporabili za prijavo na AiNguyenPhamHung, in poslali vam bomo e-poštno sporočilo za ponastavitev gesla.',
  ...
  licenseLostTip: 'Povezava z licenčnim strežnikom AiNguyenPhamHung ni uspela. Če želite še naprej uporabljati AiNguyenPhamHung, se obrnite na skrbnika.',
  licenseInactiveTip: 'Licenca AiNguyenPhamHung Enterprise za vaš delovni prostor je neaktivna. Če želite še naprej uporabljati AiNguyenPhamHung, se obrnite na skrbnika.',
  webapp: {
