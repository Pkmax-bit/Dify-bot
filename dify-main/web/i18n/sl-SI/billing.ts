const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Nanaša se na število API klicev, ki vključujejo samo sposobnosti obdelave baze znanja AiNguyenPhamHung.',
    ...
    apiRateLimitTooltip: 'API omejitev hitrosti velja za vse poizvedbe, opravljene prek AiNguyenPhamHung API, vključno z generiranjem besedila, klepetnimi pogovori, izvajanjem delovnih tokov in obdelavo dokumentov.',
  ...
  plans: {
    ...
    community: {
      features: {
        2: 'Upošteva AiNguyenPhamHung odprtokodno licenco',
