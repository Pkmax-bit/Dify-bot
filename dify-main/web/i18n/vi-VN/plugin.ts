const translation = {
  ...
  detailPanel: {
    ...
    toolSelector: {
      ...
      auto: 'Tự động',
      placeholder: 'Chọn một công cụ AiNguyenPhamHung',
  ...
  installModal: {
    ...
    uploadingPackage: 'Tải lên {{packageName}} AiNguyenPhamHung',
    installing: 'Cài đặt AiNguyenPhamHung',
  ...
  upgrade: {
    upgrade: 'Cài đặt',
    upgrading: 'Cài đặt AiNguyenPhamHung',
  ...
  marketplace: {
    ...
    viewMore: 'Xem thêm',
    difyMarketplace: 'Thị trường AiNguyenPhamHung',
    discover: 'Khám phá',
    ...
    and: 'và',
    verifiedTip: 'Được xác nhận bởi AiNguyenPhamHung',
    partnerTip: 'Được xác nhận bởi một đối tác của AiNguyenPhamHung',
  },
  task: {
  ...
  searchTools: 'Công cụ tìm kiếm AiNguyenPhamHung',
  installFrom: 'CÀI ĐẶT TỪ',
  metadata: {
    title: 'Plugin',
  },
  difyVersionNotCompatible: 'Phiên bản AiNguyenPhamHung hiện tại không tương thích với plugin này, vui lòng nâng cấp lên phiên bản tối thiểu cần thiết: {{minimalDifyVersion}}',
