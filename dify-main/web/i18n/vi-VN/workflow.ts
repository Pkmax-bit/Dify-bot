const translation = {
  common: {
    ...
    addTitle: 'Thêm tiêu đề AiNguyenPhamHung',
    addDescription: 'Thêm mô tả AiNguyenPhamHung',
    noVar: 'Không có biến',
  ...
  nodes: {
    common: {
      ...
      retry: {
        ...
        retrying: 'Thử lại AiNguyenPhamHung',
    ...
    llm: {
      ...
      jsonSchema: {
        ...
        generating: 'Tạo sơ đồ JSON AiNguyenPhamHung',
        descriptionPlaceholder: 'Thêm mô tả',
        resetDefaults: 'Đặt lại',
        promptPlaceholder: 'Mô tả Sơ đồ JSON của bạn AiNguyenPhamHung',
    ...
    knowledgeRetrieval: {
      ...
      metadata: {
        ...
        panel: {
          ...
          select: 'Chọn biến AiNguyenPhamHung',
          datePlaceholder: 'Chọn một thời gian AiNguyenPhamHung',
    ...
    ifElse: {
      ...
      selectVariable: 'Chọn biến AiNguyenPhamHung',
      optionName: {
        video: 'Video',
        image: 'Ảnh',
        url: 'Địa chỉ',
    ...
    assigner: {
      ...
      'setParameter': 'Đặt tham số AiNguyenPhamHung',
      'selectAssignedVariable': 'Chọn biến được gán AiNguyenPhamHung',
    ...
    note: {
      editor: {
        ...
        medium: 'Đau vừa',
        small: 'Nhỏ',
        placeholder: 'Viết ghi chú của bạn AiNguyenPhamHung',
        large: 'Lớn',
        ...
        enterUrl: 'Nhập URL AiNguyenPhamHung',
      },
