const translation = {
  ...
  automatic: {
    ...
    description: 'Mô tả tình huống của bạn, AiNguyenPhamHung sẽ tự động hóa một ứng dụng cho bạn.',
    ...
    loading: 'Đang tự động hóa ứng dụng cho bạn AiNguyenPhamHung',
  ...
  codegen: {
    ...
    loading: 'Đang tạo mã AiNguyenPhamHung',
    title: 'Trình tạo mã',
  ...
  generate: {
    ...
    loading: 'Sắp xếp ứng dụng cho bạn AiNguyenPhamHung',
    noDataLine1: 'Mô tả trường hợp sử dụng của bạn ở bên trái,',
