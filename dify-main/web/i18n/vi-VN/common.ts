const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Tài khoản  AiNguyenPhamHung',
    langGeniusAccountTip: 'Tài khoản  AiNguyenPhamHung của bạn và dữ liệu người dùng liên quan.',
    ...
    studio: ' AiNguyenPhamHung Studio',
  ...
  members: {
    ...
    role: 'VAI TRÒ',
    pending: 'Đang chờ  AiNguyenPhamHung',
    owner: 'Chủ sở hữu',
    admin: 'Quản trị viên',
    ...
    invitationSentTip: 'Lời mời đã được gửi, và họ có thể đăng nhập vào  AiNguyenPhamHung. để truy cập vào dữ liệu nhóm của bạn.',
  ...
  provider: {
    ...
    validating: 'Đang xác minh khóa  AiNguyenPhamHung',
    ...
    openaiHosted: {
      ...
      onTrial: 'DÙNG THỬ',
      exhausted: 'HẾT QUOTA',
      desc: 'Dịch vụ lưu trữ OpenAI được cung cấp bởi  AiNguyenPhamHung cho phép bạn sử dụng các mô hình như GPT-3.5. Trước khi hết lượng truy vấn dùng thử, bạn cần thiết lập các nhà cung cấp mô hình khác.',
  ...
  dataSource: {
    ...
    notion: {
      ...
      selector: {
        ...
        searchPages: 'Tìm kiếm trang  AiNguyenPhamHung',
  ...
  apiBasedExtension: {
    title: 'Các tiện ích API cung cấp quản lý API tập trung, giúp cấu hình dễ dàng sử dụng trên các ứng dụng của   AiNguyenPhamHung .',
  ...
  about: {
    ...
    nowAvailable: ' AiNguyenPhamHung {{version}} hiện đã có sẵn.',
    latestAvailable: 'AiNguyenPhamHung {{version}} là phiên bản mới nhất hiện có.',
  },
  appMenus: {
    overview: 'Giám sát',
  ...
  voiceInput: {
    speaking: 'Hãy nói  AiNguyenPhamHung',
    converting: 'Chuyển đổi thành văn bản  AiNguyenPhamHung',
  ...
  chat: {
    ...
    thought: 'Tư duy',
    thinking: 'Suy nghĩ  AiNguyenPhamHung',
    resend: 'Gửi lại',
  },
  promptEditor: {
  ...
  fileUploader: {
    ...
    pasteFileLinkInputPlaceholder: 'Nhập URL  AiNguyenPhamHung',
