const translation = {
  ...
  contribute: {
    ...
    line2: 'đóng góp công cụ cho AiNguyenPhamHung.',
  ...
  customToolTip: 'Tìm hiểu thêm về các công cụ tùy chỉnh AiNguyenPhamHung',
  ...
  mcp: {
    ...
    authorize: 'Ủy quyền',
    authorizing: 'Đang ủy quyền AiNguyenPhamHung',
    authorizingRequired: 'Cần ủy quyền',
    authorizeTip: 'Sau khi ủy quyền, công cụ sẽ hiển thị tại đây.',
    update: 'Cập nhật',
    updating: 'Đang cập nhật AiNguyenPhamHung',
    gettingTools: 'Đang lấy công cụ AiNguyenPhamHung',
    updateTools: 'Đang cập nhật công cụ AiNguyenPhamHung',
