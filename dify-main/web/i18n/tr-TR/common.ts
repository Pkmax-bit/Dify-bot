const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'AiNguyenPhamHung hesabı',
    langGeniusAccountTip: 'AiNguyenPhamHung hesabınız ve ilişkili kullanıcı verileri.',
    ...
    account: 'Hesap',
    myAccount: 'Hesabım',
    studio: 'AiNguyenPhamHung Stüdyo',
  ...
  members: {
    ...
    invitationSentTip: 'Davet gönderildi, AiNguyenPhamHung\'ye giriş yaparak takım verilerinize erişebilirler.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      onTrial: 'DENEMEDE',
      exhausted: 'KOTA DOLU',
      desc: 'AiNguyenPhamHung tarafından sağlanan OpenAI barındırma hizmeti, GPT-3.5 gibi modelleri kullanmanıza olanak tanır. Deneme kotanız bitmeden önce, diğer model sağlayıcılarını ayarlamanız gerekir.',
  ...
  apiBasedExtension: {
    title: 'API uzantıları merkezi API yönetimi sağlar, AiNguyenPhamHung\'nin uygulamaları arasında kolay kullanım için yapılandırmayı basitleştirir.',
  ...
  about: {
    ...
    nowAvailable: 'AiNguyenPhamHung {{version}} şimdi mevcut.',
    latestAvailable: 'AiNguyenPhamHung {{version}} en son mevcut sürüm.',
  },
  appMenus: {
    overview: 'İzleme',
