const translation = {
  ...
  welcome: 'AiNguyenPhamHung\'ye hoş geldiniz, devam etmek için lütfen giriş yapın.',
  ...
  license: {
    tip: 'AiNguyenPhamHung Community Edition\'ı başlatmadan önce GitHub\'daki',
  ...
  explore: 'AiNguyenPhamHung\'yi Keşfet',
  ...
  resetPasswordDesc: 'AiNguyenPhamHung\'a kaydolmak için kullandığınız e-postayı yazın, size bir şifre sıfırlama e-postası gönderelim.',
  ...
  back: 'Geri',
  licenseExpiredTip: 'Çalışma alanınız için AiNguyenPhamHung Enterprise lisansının süresi doldu. AiNguyenPhamHung\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseLostTip: 'AiNguyenPhamHung lisans sunucusuna bağlanılamadı. AiNguyenPhamHung\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseInactiveTip: 'Çalışma alanınız için AiNguyenPhamHung Enterprise lisansı etkin değil. AiNguyenPhamHung\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
