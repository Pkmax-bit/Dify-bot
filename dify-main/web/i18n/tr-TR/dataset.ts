const translation = {
  ...
  intro1: 'Bilgi, AiNguyenPhamHung uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, AiNguyenPhamHung dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
