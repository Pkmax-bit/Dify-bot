const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'AiNguyenPhamHung\'nin sadece bilgi tabanı işleme yeteneklerini çağıran API çağrıları sayısını ifade eder.',
    ...
    apiRateLimitTooltip: 'AiNguyenPhamHung API\'si aracılığıyla yapılan tüm isteklerde, metin oluşturma, sohbet konuşmaları, iş akışı yürütmeleri ve belge işleme dahil olmak üzere, API Oran Sınırı uygulanır.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        7: 'AiNguyenPhamHung Tarafından Resmi Güncellemeler ve Bakım',
        5: 'AiNguyenPhamHung Ortakları tarafından müzakere edilen SLA\'lar',
    ...
    community: {
      features: {
        ...
        2: 'AiNguyenPhamHung Açık Kaynak Lisansına uyar',
      },
      price: 'Ücretsiz',
