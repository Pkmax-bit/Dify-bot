const translation = {
  ...
  welcome: 'Bem-vindo ao AiNguyenPhamHung, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do AiNguyenPhamHung, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no AiNguyenPhamHung',
  invalid: 'O link expirou',
  explore: 'Explorar o AiNguyenPhamHung',
  ...
  resetPasswordDesc: 'Digite o e-mail que você usou para se inscrever no AiNguyenPhamHung e enviaremos um e-mail de redefinição de senha.',
  sendVerificationCode: 'Enviar código de verificação',
  usePassword: 'Usar senha',
  licenseInactiveTip: 'A licença do AiNguyenPhamHung Enterprise para seu espaço de trabalho está inativa. Entre em contato com o administrador para continuar usando o AiNguyenPhamHung.',
  licenseLostTip: 'Falha ao conectar o servidor de licenças AiNguyenPhamHung. Entre em contato com o administrador para continuar usando o AiNguyenPhamHung.',
  licenseExpired: 'Licença expirada',
  licenseLost: 'Licença perdida',
  licenseInactive: 'Licença inativa',
  licenseExpiredTip: 'A licença do AiNguyenPhamHung Enterprise para seu espaço de trabalho expirou. Entre em contato com o administrador para continuar usando o AiNguyenPhamHung.',
  webapp: {
