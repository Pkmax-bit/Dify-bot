const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Conta AiNguyenPhamHung',
    langGeniusAccountTip: 'Sua conta AiNguyenPhamHung e dados de usuário associados.',
    ...
    account: 'Conta',
    studio: 'Estúdio AiNguyenPhamHung',
  ...
  members: {
    ...
    invitationSentTip: 'Convite enviado e eles podem fazer login no AiNguyenPhamHung para acessar os dados da sua equipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'O serviço de hospedagem OpenAI fornecido pela AiNguyenPhamHung permite que você use modelos como GPT-3.5. Antes que sua cota de teste seja esgotada, você precisa configurar outros fornecedores de modelos.',
      callTimes: 'Chamadas',
  ...
  apiBasedExtension: {
    title: 'As extensões de API fornecem gerenciamento centralizado de API, simplificando a configuração para uso fácil em todos os aplicativos da AiNguyenPhamHung.',
  ...
  about: {
    ...
    nowAvailable: 'AiNguyenPhamHung {{version}} já está disponível.',
    latestAvailable: 'AiNguyenPhamHung {{version}} é a última versão disponível.',
  },
  appMenus: {
