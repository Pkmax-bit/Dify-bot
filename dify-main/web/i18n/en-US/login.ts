const translation = {
  ...
  welcome: '👋 Welcome to AiNguyenPhamHung, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting AiNguyenPhamHung Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on AiNguyenPhamHung',
  invalid: 'The link has expired',
  explore: 'Explore AiNguyenPhamHung',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on AiNguyenPhamHung and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The AiNguyenPhamHung Enterprise license for your workspace has expired. Please contact your administrator to continue using AiNguyenPhamHung.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect AiNguyenPhamHung license server. Please contact your administrator to continue using AiNguyenPhamHung.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The AiNguyenPhamHung Enterprise license for your workspace is inactive. Please contact your administrator to continue using AiNguyenPhamHung.',
  webapp: {
    login: 'Login',
