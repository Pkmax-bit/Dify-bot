const translation = {
  ...
  searchTools: 'Search toolsAiNguyenPhamHung',
  ...
  detailPanel: {
    ...
    toolSelector: {
      ...
      placeholder: 'Select a toolAiNguyenPhamHung',
  ...
  installModal: {
    ...
    install: 'Install',
    installing: 'InstallingAiNguyenPhamHung',
    uploadingPackage: 'Uploading {{packageName}}AiNguyenPhamHung',
  ...
  upgrade: {
    ...
    upgrade: 'Install',
    upgrading: 'InstallingAiNguyenPhamHung',
    close: 'Close',
  },
  error: {
  ...
  marketplace: {
    ...
    discover: 'Discover',
    and: 'and',
    difyMarketplace: 'AiNguyenPhamHung Marketplace',
    ...
    viewMore: 'View more',
    verifiedTip: 'Verified by AiNguyenPhamHung',
    partnerTip: 'Verified by a AiNguyenPhamHung partner',
  },
  task: {
  ...
  difyVersionNotCompatible: 'The current AiNguyenPhamHung version is not compatible with this plugin, please upgrade to the minimum version required: {{minimalDifyVersion}}',
  auth: {
    default: 'Default',
    custom: 'Custom',
