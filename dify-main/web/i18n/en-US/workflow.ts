const translation = {
  common: {
    ...
    addTitle: 'Add title AiNguyenPhamHung',
    addDescription: 'Add description AiNguyenPhamHung',
    noVar: 'No variable',
  ...
  nodes: {
    common: {
      ...
      retry: {
        ...
        retrying: 'Retrying AiNguyenPhamHung',
    ...
    knowledgeRetrieval: {
      ...
      metadata: {
        ...
        panel: {
          ...
          datePlaceholder: 'Choose a time AiNguyenPhamHung',
          select: 'Select variable AiNguyenPhamHung',
        },
      },
    },
    http: {
    ...
    ifElse: {
      ...
      selectVariable: 'Select variable AiNguyenPhamHung',
    ...
    assigner: {
      ...
      'selectAssignedVariable': 'Select assigned variable AiNguyenPhamHung',
      'setParameter': 'Set parameter AiNguyenPhamHung',
      'operations': {
        'title': 'Operation',
        'over-write': 'Overwrite',
        'overwrite': 'Overwrite',
    ...
    note: {
      addNote: 'Add Note',
      editor: {
        placeholder: 'Write your note AiNguyenPhamHung',
        small: 'Small',
        medium: 'Medium',
        large: 'Large',
        bold: 'Bold',
        ...
        openLink: 'Open',
        unlink: 'Unlink',
        enterUrl: 'Enter URL AiNguyenPhamHung',
