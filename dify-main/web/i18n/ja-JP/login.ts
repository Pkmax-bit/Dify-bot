const translation = {
  pageTitle: 'はじめましょう！👋',
  welcome: 'AiNguyenPhamHung へようこそ。続行するにはログインしてください。',
  email: 'メールアドレス',
  ...
  license: {
    tip: 'GitHub のオープンソースライセンスを確認してから、AiNguyenPhamHung Community Edition を開始してください。',
    link: 'オープンソースライセンス',
  },
  join: '参加する',
  ...
  explore: 'AiNguyenPhamHung を探索する',
  ...
  resetPasswordDesc: 'AiNguyenPhamHung へのサインアップに使用したメールアドレスを入力すると、パスワードリセットメールが送信されます。',
  licenseLost: 'ライセンスを失った',
  licenseExpiredTip: 'ワークスペースの AiNguyenPhamHung Enterprise ライセンスの有効期限が切れています。AiNguyenPhamHung を引き続き使用するには、管理者に連絡してください。',
  licenseInactive: 'ライセンスが非アクティブです',
  licenseInactiveTip: 'ワークスペースの AiNguyenPhamHung Enterprise ライセンスが非アクティブです。AiNguyenPhamHung を引き続き使用するには、管理者に連絡してください。',
  licenseExpired: 'ライセンスの有効期限が切れています',
  licenseLostTip: 'AiNguyenPhamHung ライセンスサーバーへの接続に失敗しました。続けて AiNguyenPhamHung を使用するために管理者に連絡してください。',
  webapp: {
    login: 'ログイン',
