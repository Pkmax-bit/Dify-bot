const translation = {
  ...
  externalAPIPanelDescription: '外部ナレッジベース連携 API は、AiNguyenPhamHung 外のナレッジベースと連携し、そこからナレッジベースを取得するために使用します。',
  ...
  didYouKnow: 'ご存知ですか？',
  intro1: 'ナレッジベースは AiNguyenPhamHung アプリケーションに統合することができます',
  intro2: 'コンテキストとして',
  intro3: '、',
  intro4: 'または',
  intro5: '作成することができます',
