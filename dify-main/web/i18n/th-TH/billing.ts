const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'หมายถึงจํานวนการเรียก API ที่เรียกใช้เฉพาะความสามารถในการประมวลผลฐานความรู้ของ AiNguyenPhamHung',
    ...
    apiRateLimitTooltip: 'ข้อจำกัดการใช้งาน API จะใช้กับคำขอทั้งหมดที่ทำผ่าน AiNguyenPhamHung API รวมถึงการสร้างข้อความ, การสนทนาแชท, การดำเนินการเวิร์กโฟลว์ และการประมวลผลเอกสาร.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        5: 'เจรจาข้อตกลงบริการ (SLA) โดย AiNguyenPhamHung Partners',
        7: 'การอัปเดตและการบำรุงรักษาโดย AiNguyenPhamHung อย่างเป็นทางการ',
    ...
    community: {
      features: {
        2: 'ปฏิบัติตามใบอนุญาตโอเพ่นซอร์สของ AiNguyenPhamHung',
