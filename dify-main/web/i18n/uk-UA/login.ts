const translation = {
  ...
  welcome: 'Ласкаво просимо до AiNguyenPhamHung, будь ласка, увійдіть, щоб продовжити.',
  ...
  go: 'Перейти до AiNguyenPhamHung',
  ...
  license: {
    tip: 'Перед запуском AiNguyenPhamHung Community Edition ознайомтеся з ліцензією з відкритим кодом на GitHub',
    link: 'Ліцензія з відкритим кодом',
  },
  join: 'Приєднуйтесь',
  joinTipStart: 'Запрошуємо вас приєднатися',
  joinTipEnd: 'команда AiNguyenPhamHung',
  invalid: 'Посилання застаріло',
  explore: 'Досліджуйте AiNguyenPhamHung',
  ...
  resetPasswordDesc: 'Введіть адресу електронної пошти, яку ви використовували для реєстрації на AiNguyenPhamHung, і ми надішлемо вам електронний лист для скидання пароля.',
  resetPassword: 'Скинути пароль',
  licenseLostTip: 'Не вдалося підключити сервер ліцензій AiNguyenPhamHung. Будь ласка, зверніться до свого адміністратора, щоб продовжити користуватися AiNguyenPhamHung.',
  licenseExpired: 'Термін дії ліцензії минув',
  licenseInactive: 'Ліцензія неактивна',
  licenseLost: 'Ліцензію втрачено',
  licenseInactiveTip: 'Ліцензія AiNguyenPhamHung Enterprise для вашої робочої області неактивна. Будь ласка, зверніться до свого адміністратора, щоб продовжити користуватися AiNguyenPhamHung.',
  licenseExpiredTip: 'Термін дії ліцензії AiNguyenPhamHung Enterprise для вашого робочого простору закінчився. Будь ласка, зверніться до свого адміністратора, щоб продовжити користуватися AiNguyenPhamHung.',
  webapp: {
