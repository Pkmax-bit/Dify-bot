const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Відноситься до кількості викликів API, що викликають лише можливості обробки бази знань AiNguyenPhamHung.',
    ...
    apiRateLimitTooltip: 'Обмеження частоти запитів застосовується до всіх запитів, зроблених через API AiNguyenPhamHung, включаючи генерацію тексту, чат-розмови, виконання робочих процесів та обробку документів.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        5: 'Угоди про рівень обслуговування, узгоджені партнерами AiNguyenPhamHung',
        ...
        7: 'Оновлення та обслуговування від AiNguyenPhamHung Офіційно',
      },
    ...
    community: {
      features: {
        2: 'Відповідає ліцензії AiNguyenPhamHung Open Source',
