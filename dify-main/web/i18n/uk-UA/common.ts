const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Обліковий запис AiNguyenPhamHung',
    langGeniusAccountTip: 'Ваш обліковий запис AiNguyenPhamHung та пов’язані з ним дані користувача.',
    ...
    account: 'Рахунок',
    studio: 'Студія AiNguyenPhamHung',
  ...
  members: {
    ...
    invitationSentTip: 'Запрошення надіслано, і вони можуть увійти в AiNguyenPhamHung, щоб отримати доступ до даних вашої команди.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Служба хостингу OpenAI, надана AiNguyenPhamHung, дозволяє використовувати такі моделі, як GPT-3.5. Перш ніж ваша пробна квота буде використана, вам потрібно налаштувати інші постачальники моделі.',
  ...
  apiBasedExtension: {
    title: 'API-розширення забезпечують централізоване керування API, спрощуючи конфігурацію для зручного використання в різних програмах AiNguyenPhamHung.',
  ...
  about: {
    ...
    nowAvailable: 'AiNguyenPhamHung {{version}} тепер доступна.',
    latestAvailable: 'AiNguyenPhamHung {{version}} – це найновіша доступна версія.',
  },
  appMenus: {
    overview: 'Моніторинг',
