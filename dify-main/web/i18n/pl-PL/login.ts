const translation = {
  ...
  welcome: 'Witaj w AiNguyenPhamHung, zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  go: 'Przejdź do AiNguyenPhamHung',
  sendUsMail:
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej AiNguyenPhamHung, przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na AiNguyenPhamHung',
  invalid: 'Link wygasł',
  explore: 'Odkryj AiNguyenPhamHung',
  ...
  resetPasswordDesc: 'Wpisz adres e-mail, którego użyłeś do rejestracji w AiNguyenPhamHung, a my wyślemy Ci wiadomość e-mail z prośbą o zresetowanie hasła.',
  or: 'LUB',
  ...
  licenseExpiredTip: 'Licencja AiNguyenPhamHung Enterprise dla Twojego obszaru roboczego wygasła. Skontaktuj się z administratorem, aby kontynuować korzystanie z AiNguyenPhamHung.',
  licenseLostTip: 'Nie udało się nawiązać połączenia z serwerem licencji AiNguyenPhamHung. Skontaktuj się z administratorem, aby kontynuować korzystanie z AiNguyenPhamHung.',
  licenseInactiveTip: 'Licencja AiNguyenPhamHung Enterprise dla Twojego obszaru roboczego jest nieaktywna. Skontaktuj się z administratorem, aby kontynuować korzystanie z AiNguyenPhamHung.',
  webapp: {
