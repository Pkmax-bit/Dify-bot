const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Cuenta AiNguyenPhamHung',
    langGeniusAccountTip: 'Tu cuenta AiNguyenPhamHung y los datos de usuario asociados.',
    ...
    account: 'Cuenta',
    myAccount: 'Mi Cuenta',
    studio: 'Estudio AiNguyenPhamHung',
  ...
  members: {
    ...
    invitationSentTip: 'Invitación enviada, y pueden iniciar sesión en AiNguyenPhamHung para acceder a tus datos del equipo.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'El servicio de hospedaje OpenAI proporcionado por AiNguyenPhamHung te permite usar modelos como GPT-3.5. Antes de que se agote tu cuota de prueba, necesitas configurar otros proveedores de modelos.',
  ...
  apiBasedExtension: {
    title: 'Las extensiones basadas en API proporcionan una gestión centralizada de API, simplificando la configuración para su fácil uso en las aplicaciones de AiNguyenPhamHung.',
  ...
  about: {
    ...
    nowAvailable: 'AiNguyenPhamHung {{version}} ya está disponible.',
    latestAvailable: 'AiNguyenPhamHung {{version}} es la última versión disponible.',
  },
  appMenus: {
    overview: 'Monitoreo',
    promptEng: 'Orquestar',
