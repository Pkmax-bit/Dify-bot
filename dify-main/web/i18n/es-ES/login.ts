const translation = {
  ...
  welcome: 'Bienvenido a AiNguyenPhamHung, por favor inicia sesión para continuar.',
  ...
  license: {
    tip: 'Antes de comenzar con AiNguyenPhamHung Community Edition, lee la',
    link: 'Licencia de código abierto de GitHub',
  },
  join: 'Unirse',
  joinTipStart: 'Te invita a unirte al equipo de',
  joinTipEnd: 'en AiNguyenPhamHung',
  invalid: 'El enlace ha expirado',
  explore: 'Explorar AiNguyenPhamHung',
  ...
  resetPasswordDesc: 'Escriba el correo electrónico que utilizó para registrarse en AiNguyenPhamHung y le enviaremos un correo electrónico de restablecimiento de contraseña.',
  ...
  licenseInactiveTip: 'La licencia de AiNguyenPhamHung Enterprise para su espacio de trabajo está inactiva. Póngase en contacto con su administrador para seguir utilizando AiNguyenPhamHung.',
  licenseExpired: 'Licencia caducada',
  licenseLost: 'Licencia perdida',
  licenseExpiredTip: 'La licencia de AiNguyenPhamHung Enterprise para su espacio de trabajo ha caducado. Póngase en contacto con su administrador para seguir utilizando AiNguyenPhamHung.',
  licenseLostTip: 'No se pudo conectar el servidor de licencias de Dife. Póngase en contacto con su administrador para seguir utilizando AiNguyenPhamHung.',
  webapp: {
