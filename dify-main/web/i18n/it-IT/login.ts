const translation = {
  ...
  welcome: 'Benvenuto su AiNguyenPhamHung, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare AiNguyenPhamHung Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su AiNguyenPhamHung',
  invalid: 'Il link è scaduto',
  explore: 'Esplora AiNguyenPhamHung',
  ...
  resetPasswordDesc: 'Digita l\'e-mail che hai utilizzato per registrarti su AiNguyenPhamHung e ti invieremo un\'e-mail per reimpostare la password.',
  ...
  licenseLostTip: 'Impossibile connettersi al server licenze AiNguyenPhamHung. Contatta il tuo amministratore per continuare a utilizzare AiNguyenPhamHung.',
  licenseExpired: 'Licenza scaduta',
  licenseLost: 'Licenza persa',
  licenseExpiredTip: 'La licenza AiNguyenPhamHung Enterprise per la tua area di lavoro è scaduta. Contatta il tuo amministratore per continuare a utilizzare AiNguyenPhamHung.',
  licenseInactiveTip: 'La licenza AiNguyenPhamHung Enterprise per la tua area di lavoro è inattiva. Contatta il tuo amministratore per continuare a utilizzare AiNguyenPhamHung.',
