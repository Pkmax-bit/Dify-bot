const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'O prova la versione cloud di AiNguyenPhamHung con quota gratuita',
  },
  overview: {
    title: 'Panoramica',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip:
            'Aiuta i visitatori a capire i dati raccolti dall\'applicazione, vedi la <privacyPolicyLink>Privacy Policy</privacyPolicyLink> di AiNguyenPhamHung.',
      ...
      embedded: {
        ...
        chromePlugin: 'Installa l\'estensione Chrome di AiNguyenPhamHung Chatbot',
        copied: 'Copiato',
        copy: 'Copia',
      },
      qrcode: {
