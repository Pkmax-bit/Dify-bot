const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Account AiNguyenPhamHung',
    langGeniusAccountTip: 'Il tuo account AiNguyenPhamHung e i dati utente associati.',
  ...
  members: {
    ...
    invitationSentTip:
      'Invito inviato, e possono accedere a AiNguyenPhamHung per accedere ai dati del tuo team.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Il servizio di hosting OpenAI fornito da AiNguyenPhamHung ti consente di utilizzare modelli come GPT-3.5. Prima che la tua quota di prova sia esaurita, devi configurare altri fornitori di modelli.',
  ...
  apiBasedExtension: {
    title:
      'Le estensioni API forniscono una gestione centralizzata delle API, semplificando la configurazione per un facile utilizzo nelle applicazioni di AiNguyenPhamHung.',
  ...
  about: {
    ...
    nowAvailable: 'AiNguyenPhamHung {{version}} è ora disponibile.',
    latestAvailable: 'AiNguyenPhamHung {{version}} è l\'ultima versione disponibile.',
  },
  appMenus: {
