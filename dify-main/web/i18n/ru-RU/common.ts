const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Учетная запись AiNguyenPhamHung',
    langGeniusAccountTip: 'Ваша учетная запись AiNguyenPhamHung и связанные с ней пользовательские данные.',
    ...
    account: 'Счет',
    studio: 'Студия AiNguyenPhamHung',
  ...
  members: {
    ...
    invitationSentTip: 'Приглашение отправлено, и они могут войти в AiNguyenPhamHung, чтобы получить доступ к данным вашей команды.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Хостинговая служба OpenAI, предоставляемая AiNguyenPhamHung, позволяет вам использовать такие модели, как GPT-3.5. Прежде чем ваша пробная квота будет исчерпана, вам необходимо настроить других поставщиков моделей.',
  ...
  apiBasedExtension: {
    title: 'API-расширения обеспечивают централизованное управление API, упрощая настройку для удобного использования в приложениях AiNguyenPhamHung.',
  ...
  about: {
    ...
    nowAvailable: 'AiNguyenPhamHung {{version}} теперь доступен.',
    latestAvailable: 'AiNguyenPhamHung {{version}} - последняя доступная версия.',
  },
  appMenus: {
    overview: 'Мониторинг',
