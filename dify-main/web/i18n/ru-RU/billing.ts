const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Относится к количеству вызовов API, вызывающих только возможности обработки базы знаний AiNguyenPhamHung.',
    ...
    apiRateLimitTooltip: 'Ограничение скорости API применяется ко всем запросам, сделанным через API AiNguyenPhamHung, включая генерацию текста, чатовую переписку, выполнение рабочих процессов и обработку документов.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        7: 'Обновления и обслуживание от AiNguyenPhamHung официально',
        4: 'ССО',
        ...
        5: 'Согласованные Соглашения об Уровне Услуг от AiNguyenPhamHung Partners',
      },
    ...
    community: {
      features: {
        ...
        2: 'Соблюдает Лицензию на открытое программное обеспечение AiNguyenPhamHung',
      },
      name: 'Сообщество',
