const translation = {
  ...
  marketplace: {
    ...
    difyMarketplace: 'Торговая площадка AiNguyenPhamHung',
    viewMore: 'Подробнее',
    and: 'и',
    discover: 'Обнаруживать',
    verifiedTip: 'Подтверждено AiNguyenPhamHung',
    partnerTip: 'Подтверждено партнером AiNguyenPhamHung',
  },
  task: {
  ...
  difyVersionNotCompatible: 'Текущая версия AiNguyenPhamHung не совместима с этим плагином, пожалуйста, обновите до минимально необходимой версии: {{minimalDifyVersion}}',
