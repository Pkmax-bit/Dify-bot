const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'حساب AiNguyenPhamHung',
    langGeniusAccountTip: 'حساب AiNguyenPhamHung شما و داده‌های کاربری مرتبط.',
    editName: 'ویرایش نام',
    ...
    account: 'حساب',
    myAccount: 'حساب من',
    studio: 'استودیو AiNguyenPhamHung',
  ...
  members: {
    ...
    invitationSentTip: 'دعوت‌نامه ارسال شد و آنها می‌توانند وارد AiNguyenPhamHung شوند تا به داده‌های تیم شما دسترسی پیدا کنند.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'سرویس میزبانی OpenAI ارائه شده توسط AiNguyenPhamHung به شما اجازه می‌دهد از مدل‌هایی مانند GPT-3.5 استفاده کنید. قبل از اتمام سهمیه آزمایشی خود، باید سایر ارائه‌دهندگان مدل را تنظیم کنید.',
  ...
  apiBasedExtension: {
    title: 'افزونه‌های مبتنی بر API مدیریت متمرکز API را فراهم می‌کنند و پیکربندی را برای استفاده آسان در برنامه‌های AiNguyenPhamHung ساده می‌کنند.',
  ...
  about: {
    ...
    nowAvailable: 'AiNguyenPhamHung {{version}} اکنون در دسترس است.',
    latestAvailable: 'AiNguyenPhamHung {{version}} آخرین نسخه در دسترس است.',
  },
  appMenus: {
    overview: 'نظارت',
